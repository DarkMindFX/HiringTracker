...
namespace HRT.DAL.MSSQL 
{
    ...
    public class CandidateSkillDal: SQLDal, ICandidateSkillDal
    {
        ...
        {
            bool removed = base.Delete<CandidateSkill>("p_CandidateSkill_Delete", id, "@ID");

            return removed;
        }

        public CandidateSkill Get(long id)
        {
            CandidateSkill entityOut = base.Get<CandidateSkill>("p_CandidateSkill_GetDetails", id, "@ID", CandidateSkillFromRow);
        ...
        public CandidateSkill Upsert(CandidateSkill entity) 
        {
            CandidateSkill entityOut = base.Upsert<CandidateSkill>("p_CandidateSkill_Upsert", entity, AddUpsertParameters, CandidateSkillFromRow);
