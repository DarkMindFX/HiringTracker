...
namespace HRT.DAL.MSSQL
{
    ...
    public class ProposalDal : SQLDal, IProposalDal
    {
        ...
        {
            IList<Proposal> result = null;

            using (SqlConnection conn = OpenConnection())
            {
                SqlCommand cmd = new SqlCommand("p_Proposal_GetByCandidate", conn);
        ...
        public IList<Proposal> GetByPosition(long id)
        {
            ...
            using (SqlConnection conn = OpenConnection())
            {
                SqlCommand cmd = new SqlCommand("p_Proposal_GetByPosition", conn);
                cmd.CommandType = System.Data.CommandType.StoredProcedure;
