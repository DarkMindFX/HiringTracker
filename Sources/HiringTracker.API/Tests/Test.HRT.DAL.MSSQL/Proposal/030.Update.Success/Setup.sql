...
DECLARE @Proposed DATETIME = '7/16/2021 10:20:45 AM'
DECLARE @CurrentStepID BIGINT = 2
DECLARE @StepSetDate DATETIME = '12/4/2018 8:06:45 PM'
DECLARE @NextStepID BIGINT = 5
DECLARE @DueDate DATETIME = '12/4/2018 8:06:45 PM'
DECLARE @StatusID BIGINT = 4
DECLARE @CreatedByID BIGINT = 100001
DECLARE @CreatedDate DATETIME = '3/3/2019 6:20:45 AM'
DECLARE @ModifiedByID BIGINT = 100003
DECLARE @ModifiedDate DATETIME = '1/11/2022 4:07:45 PM'
