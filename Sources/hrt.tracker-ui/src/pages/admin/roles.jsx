...
class RolesPage extends React.Component {
    ...
    onRowClick(event) {
        const row = event.row;
        if(row) {
            this.props.history.push(`/role/edit/${row.id}`);
        }
    ...
    render() {
        ...
        return (
            <div style={{ height: 500, width: '100%' }}>
                ...
                <Button variant="contained" component={Link} color="primary" size="small" to="/role/new" >+ Role</Button>        
            </div>
        );
    }
    ...
    _redirectToLogin()
    {        
        this._pageHelper.redirectToLogin(`/roles`);
    }
}
